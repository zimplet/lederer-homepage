...
import { BLOG_POSTS, getFeaturedPost, formatPostDate } from "@/lib/blog";
            ...
            {rest.map((post) => (
              ...
              >
                ...
                <div className="relative h-44 overflow-hidden bg-gradient-to-br from-dark/8 to-cream-dark">
                  ...
                  <div
                    className="absolute bottom-0 left-0 right-0 h-[2px] origin-left scale-x-0 bg-red transition-transform duration-500 group-hover:scale-x-100"
                    aria-hidden="true"
                  />
                </div>
